...
def test_one_stock(i = 1.0):
    ...
    mock_data = create_mock_data(order_book_ids=order_book_ids, start_date="2019-01-01", end_date="2019-01-03")
...
def test_cost(i = 1.0):
    ...
    portfolio_reward = np.array(env.experience_buffer["reward"])
    fee = portfolio_reward-expected_reward

    #np.testing.assert_almost_equal(portfolio_reward, expected_reward, decimal=3)

    return portfolio_reward, fee
...
if __name__ == "__main__":
    ...
    # print(test_one_stock(i=-1))
     print(test_one_stock(i=0)) # risk_free_return = 0.0001 in data_generator
    # print(test_cost(i=1))
